...
public class TestUtils {
  ...
  public static List<GdeConfig> gdeConfigurations =
      Arrays.asList(
          GdeConfig.builder().type("type1").build(),
          GdeConfig.builder().type("type2").build());
  ...
  public static List<CdsSoggettoServizio> cdsSoggettiServizi =
      Arrays.asList(
          CdsSoggettoServizio.builder().id(1l)
              .servizio(cdsServizi.get(0))
              .soggetto(cdsSoggetti.get(0)).build(),
          CdsSoggettoServizio.builder().id(2l)
              .servizio(cdsServizi.get(1))
              .soggetto(cdsSoggetti.get(1)).build());
}
